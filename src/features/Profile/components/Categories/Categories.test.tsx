...
import { Categories } from 'src/features/Profile/components/Categories/Categories';
...
describe('test Categories', () => {
  ...
  test('renders the first tab panel initially', () => {
    ...
    expect(screen.getByRole('tabpanel', { name: SKILLS.categories[0].name })).toBeInTheDocument();
  });

...
describe("test NavBar", () => {
  function testLinksAreRendered(extraLinks = 0) {
    expect(screen.getAllByRole("link")).toHaveLength(
      NAV_BAR_LINKS.length + extraLinks,
    );
  }
  ...
  describe("test !mdAndUp screen size", () => {
    ...
    describe("test the drawer functionality", () => {
      function clickDrawerButton(user: typeof userEvent) {
  ...
  describe("test mdAndUp screen size", () => {
    ...
    test("renders the links", () => {
      ...
      // There is one additional link
      // because of the logo when the drawer isn't opened
